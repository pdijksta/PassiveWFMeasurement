...
def gen_beam(nemitx, nemity, betax, alphax, betay, alphay, p_central, rms_bunch_duration, n_particles, cutoff_sigma=5, n_mesh=200):
...
if __name__ == '__main__':
    ...
    n_particles = 100e3
    cutoff_sigma = 5
    gen_beam(nemitx, nemity, betax, alphax, betay, alphay, p_central, rms_bunch_duration, n_particles, cutoff_sigma=10)
